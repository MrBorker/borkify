...
import { SwipeBtn, Filter } from "../../components";
...
import { selectCollaborators } from "../../redux/selects";
...
function Matches() {
  ...
  const handleSelect = async (user) => {
    ...
    await setDoc(
      ...
      {
        shownUsers: arrayUnion(collaborators[usersCounter]?.userId),
      },
      { merge: true }
    );

    const combinedId =
      userInfo.userId < collaborators[usersCounter]?.userId
        ? userInfo.userId + collaborators[usersCounter]?.userId
        : collaborators[usersCounter]?.userId + userInfo.userId;
    ...
    try {
      ...
      await setDoc(
        doc(firestore, "userChats", userInfo.userId),
        {
          [combinedId]: {
            userInfo: {
              userId: collaborators[usersCounter]?.userId,
              displayName: collaborators[usersCounter]?.userName,
              photoUrl: collaborators[usersCounter]?.avatarUrl,
            },
      ...
      await setDoc(
        doc(firestore, "userChats", collaborators[usersCounter]?.userId),
        {
          [combinedId]: {
            userInfo: {
        ...
        <div className={styles["presentation"]}>
          <div className={styles["avatar"]}>
            <img
              ...
              src={collaborators[usersCounter]?.avatarUrl}
              alt=""
            />
          ...
          <div className={styles["info"]}>
            <div className={styles["header-container"]}>
              <h4 className={styles["header"]}>
                {collaborators[usersCounter]?.userName}
              </h4>
            ...
            <div className={styles["bio"]}>
              <div className={styles["bio-raw"]}>
                ...
                <span className={styles["title"]}>
                  {collaborators[usersCounter]?.location}
                </span>
              </div>
              <div className={styles["bio-raw"]}>
                <div className={styles["bio-icon"]}>
                ...
                <span className={styles["title"]}>
                  {collaborators[usersCounter]?.gender}
                </span>
              </div>
              <div className={styles["bio-raw"]}>
                <div className={styles["bio-icon"]}>
                ...
                <span className={styles["title"]}>
                  {collaborators[usersCounter]?.breed}
                </span>
              </div>
              <div className={styles["bio-raw"]}>
                <div className={styles["bio-icon"]}>
                ...
                <span className={styles["title"]}>
                  {collaborators[usersCounter]?.age} years
                </span>
              </div>
              <div className={styles["bio-raw"]}>
                <div className={styles["bio-icon"]}>
            ...
            <p className={styles["about"]}>
              {collaborators[usersCounter]?.about}
            </p>
          </div>
        </div>
      )}
